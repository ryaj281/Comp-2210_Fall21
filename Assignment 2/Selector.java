 ...
 *
 * @author Ryan Johnson (raj0035@auburn.edu)
 *
 */
 ...
 */
    ...
    public static <T> T ceiling(Collection<T> coll, T key, Comparator<T> comp) {
         ...
         for (T element : coll) {
            if (comp.compare(element, ceiling) <= 0 && comp.compare(element, key) >= 0) {
               ceiling = element;
            }
         }
         return ceiling;
    ...
    public static <T> T floor(Collection<T> coll, T key, Comparator<T> comp) {
        if (coll == null || comp == null) {
         ...
         for (T element : coll) {
            if (comp.compare(element, floor) >= 0 && comp.compare(element, key) <= 0) {
               floor = element;
            }
         }
         return floor;
